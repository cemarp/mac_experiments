...
public struct BatteryControlState: Codable {
    public var chargeLimitEnabled: Bool // Toggle the limit
    ...
    public init(chargeLimitEnabled: Bool = true, chargeLimit: Int = 80, sailingModeEnabled: Bool = false, sailingModeLowerLimit: Int = 75, forceDischarge: Bool = false) {
